 ...
 * <!-- end-user-doc -->
 * @see br.usp.icmc.amenu.aMenu.AMenuPackage#getDirection()
 * @model
 * @generated
 */
public enum Direction implements Enumerator
{
  ...
  /**
   * The '<em><b>Rlt</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #RLT_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Rlt</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Rlt</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #RLT
   ...
   * @ordered
   */
  public static final int RLT_VALUE = 1;
